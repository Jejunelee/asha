...
"[project]/src/app/Alumni/components/Header.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/Alumni/components/Section1.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Section1() {
    ...
    const [slideWidth, setSlideWidth] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(280 + 20);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Section1.useEffect": ()=>{
            setMounted(true);
            const handleResize = {
                "Section1.useEffect.handleResize": ()=>{
            ...
            return ({
                "Section1.useEffect": ()=>window.removeEventListener('resize', handleResize)
            })["Section1.useEffect"];
        }
    }["Section1.useEffect"], []);
    ...
    const startAutoplay = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Section1.useCallback[startAutoplay]": ()=>{
            if (autoplayRef.current) clearInterval(autoplayRef.current);
            autoplayRef.current = setInterval({
                "Section1.useCallback[startAutoplay]": ()=>{
                    setCurrentIndex({
                        "Section1.useCallback[startAutoplay]": (prev)=>prev + 1
                    }["Section1.useCallback[startAutoplay]"]);
                }
            }["Section1.useCallback[startAutoplay]"], 3000); // Changed from 1000ms to 3000ms for better user experience
        }
    }["Section1.useCallback[startAutoplay]"], []);
    const stopAutoplay = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Section1.useCallback[stopAutoplay]": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Section1.useEffect": ()=>{
            ...
            return ({
                "Section1.useEffect": ()=>stopAutoplay()
            })["Section1.useEffect"];
        }
    }["Section1.useEffect"], [
        mounted,
    ...
    const nextSlide = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Section1.useCallback[nextSlide]": ()=>{
            stopAutoplay();
            setCurrentIndex({
                "Section1.useCallback[nextSlide]": (prev)=>prev + 1
            }["Section1.useCallback[nextSlide]"]);
            startAutoplay();
        }
    }["Section1.useCallback[nextSlide]"], [
    ...
    const prevSlide = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Section1.useCallback[prevSlide]": ()=>{
            stopAutoplay();
            setCurrentIndex({
                "Section1.useCallback[prevSlide]": (prev)=>prev - 1
            }["Section1.useCallback[prevSlide]"]);
            startAutoplay();
        }
    }["Section1.useCallback[prevSlide]"], [
    ...
    const handleMouseEnter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Section1.useCallback[handleMouseEnter]": ()=>{
            stopAutoplay();
        }
    }["Section1.useCallback[handleMouseEnter]"], [
        stopAutoplay
    ...
    const handleMouseLeave = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Section1.useCallback[handleMouseLeave]": ()=>{
            startAutoplay();
        }
    }["Section1.useCallback[handleMouseLeave]"], [
        startAutoplay
    ...
    const getActualImageIndex = (index)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        className: "w-full bg-[#F5F5F5] py-8 sm:py-12 md:py-16 lg:py-20 xl:py-24 overflow-hidden",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "max-w-8xl w-[92%] sm:w-[90%] md:w-[88%] mx-auto px-3 sm:px-4 md:px-6 lg:px-8 xl:px-12",
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex flex-col lg:flex-row lg:items-center lg:gap-6 xl:gap-8 2xl:gap-12",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "lg:w-2/5 xl:w-1/3 mb-6 sm:mb-8 lg:mb-0 text-center lg:text-left",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                className: "font-jost text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-black font-bold leading-tight",
                                children: "Our"
                            }, void 0, false, {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                className: "font-jost text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-[#921A1B] font-semibold leading-[0.9] sm:leading-[0.85]",
                                children: "Proud Alumni"
                            }, void 0, false, {
                                fileName: "[project]/src/app/Alumni/components/Section1.tsx",
                                lineNumber: 141,
                                columnNumber: 13
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "mt-2 sm:mt-3 md:mt-4 font-jost text-sm sm:text-base md:text-lg lg:text-xl text-black/70 px-2 sm:px-0",
                                children: "Living their dreams (or Where they are now)"
                            }, void 0, false, {
                                fileName: "[project]/src/app/Alumni/components/Section1.tsx",
                                lineNumber: 145,
                                columnNumber: 13
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "mt-5 sm:mt-6 md:mt-8 flex gap-3 justify-center lg:justify-start",
                                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "absolute left-0 top-0 bottom-0 w-12 sm:w-16 md:w-20 lg:w-24 xl:w-28 z-20 pointer-events-none bg-gradient-to-r from-[#F5F5F5] via-[#F5F5F5]/90 to-transparent"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/Alumni/components/Section1.tsx",
                                        lineNumber: 180,
                                        columnNumber: 15
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "absolute right-0 top-0 bottom-0 w-12 sm:w-16 md:w-20 lg:w-24 xl:w-28 z-20 pointer-events-none bg-gradient-to-l from-[#F5F5F5] via-[#F5F5F5]/90 to-transparent"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/Alumni/components/Section1.tsx",
                                        lineNumber: 183,
                                        columnNumber: 15
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: extendedImages.map((src, index)=>{
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: images.map((_, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: `h-1.5 sm:h-2 rounded-full transition-all duration-300 ${currentDotIndex === idx ? 'w-4 sm:w-5 md:w-6 bg-[#921A1B]' : 'w-1.5 sm:w-2 bg-[#921A1B]/40 hover:bg-[#921A1B]/70'}`,
...
_s(Section1, "y4jkS+pLJOi1Ir2rtLSVRieqc8U=");
_c = Section1;
var _c;
...
//# sourceMappingURL=_f54483ed._.js.map