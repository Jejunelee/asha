// app/our-programs/bartending/page.tsx
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="w-full bg-white">
        ...
        <div className="relative w-full h-[clamp(260px,70vh,730px)] overflow-hidden group">
          <Image
            src="/Programs/Specific/5.png"
            alt="Bartending - Hospitality education and training"
            fill
            priority
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
          ...
          <div className="space-y-6">
            ...
            <h3 className="font-jost text-lg sm:text-xl md:text-2xl lg:text-3xl text-[#921A1B] font-medium flex flex-wrap items-center gap-3">
              Speed, Precision and Personality.
            </h3>

            <div className="font-jost leading-tight text-black space-y-4 text-sm sm:text-base md:text-2xl">
              <p>
                Friday night. The bar is packed three deep. Tickets are printing faster than you can read them, and you have a line of orders: someone wants six different cocktails, someone wants something "like a mojito but not a mojito," and someone just wants a beer but can't decide which one.
              </p>

              <p>
                You handle all of it with speed, accuracy, and the kind of service that earns good tips.
              </p>

              <p>
                This course teaches you classic and contemporary cocktail preparation, bar management, and customer service under pressure. You'll learn to mix, shake, and serve with the speed and precision that keeps the bar moving and the tips coming.
              </p>
              ...
              <p>
                • Classic cocktail preparation and technique
                <br />
                • Contemporary craft cocktails and trends
                <br />
                • Speed and efficiency behind the bar
                <br />
                • Bar setup, stocking, and inventory
                <br />
